        ...
        <>
            <div className='flex justify-center'>
                <div className='p-2 items-center md:-my-3 md:h-12 xl:px-8 flex flex-col gap-5 text-black'>
                    <div className='flex gap-5 text-lg  p-1 rounded-full px-8'>
                    ...
                    className='p-2 px-8 rounded-full uppercase flex items-center text-sm font-sans font-semibold text-white bg-indigo-800 hover:bg-indigo-600 shadow-lg shadow-black/60 duration-150'>Add to Cart</button>
                </div>
            </div>
        </>
    );
